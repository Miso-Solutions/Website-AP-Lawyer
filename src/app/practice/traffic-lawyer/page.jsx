...
const PAGE_PATH = '/practice/traffic-lawyer';

const practiceSchema = {
  '@context': 'https://schema.org',
  '@type': 'LegalService',
  '@id': `${BASE_URL}${PAGE_PATH}#legal-service`,
  name: 'עורך דין תעבורה - אלון פרדו',
  alternateName: 'Traffic Law Lawyer - Alon Pardo',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'עורך דין תעבורה', item: `${BASE_URL}${PAGE_PATH}` },
  ],
};
...
export default function TrafficLawyerPage() {
  return (
    <>
      <SubpageShell areaKey="transport" />
