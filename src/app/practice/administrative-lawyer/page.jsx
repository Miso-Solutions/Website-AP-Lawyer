...
const PAGE_PATH = '/practice/administrative-lawyer';

const practiceSchema = {
  '@context': 'https://schema.org',
  '@type': 'LegalService',
  '@id': `${BASE_URL}${PAGE_PATH}#legal-service`,
  name: 'עורך דין מנהלי - אלון פרדו',
  alternateName: 'Administrative Law Lawyer - Alon Pardo',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'עורך דין מנהלי', item: `${BASE_URL}${PAGE_PATH}` },
  ],
};
