...
export default function Navbar() {
  ...
  // Close on Escape (WCAG 2.1.1) + focus trap (WCAG 2.4.3)
  useEffect(() => {
    ...
    const handleKey = (e) => {
      ...
      const focusable = [menuBtnRef.current, ...menu.querySelectorAll('a,button')].filter(Boolean);
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <Link
            ...
            className="hidden lg:inline-block bg-stone-900 text-white px-8 py-2 text-xs uppercase tracking-widest hover:bg-gold focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-gold transition"
      ...
      >
        ...
        <Link
          ...
          className="block bg-stone-900 text-white px-6 py-3 text-xs uppercase tracking-widest hover:bg-gold focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-gold transition text-center"
        >
          {t('nav_get_in_touch')}
        </Link>
      </div>
